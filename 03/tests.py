...
class TestMyList(unittest.TestCase):
    ...
    def test_add_zeros_same_len(self):
        ...
        self.assertEqual(MyList._MyList__add_zeros(a, a.lst, 3), [0, 3, 2])

    def test_add_zeros_dif_len(self):
        a = MyList([0, 3, 2])
        
        self.assertEqual(MyList._MyList__add_zeros(a, a.lst, 5), [0, 3, 2, 0, 0])
    ...
    def test___get_max_list_by_size_dif_len(self):
        ...
        self.assertEqual(MyList.get_max_list_by_size(lst1, lst2), [0, 1, 2, 5])
    ...
    def test___handle_2list_left(self, mock_get_max_list):
        ...
        mock_get_max_list.return_value = a
